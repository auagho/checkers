...
import AuaghoCheckersAuaghoCheckersCheckers from './auagho/checkers/auagho.checkers.checkers'
...
export default { 
  AuaghoCheckersAuaghoCheckersCheckers: load(AuaghoCheckersAuaghoCheckersCheckers, 'auagho.checkers.checkers'),
